...
const Header = () => {
  ...
  return (
    <header className="md:p-2 px-6 pt-5 md:px-12 md:border-b border-b-zinc-800 bg-none border-none md:bg-zinc-200 md:dark:bg-stone-800 w-full flex flex-row justify-between items-center">
